...
public class list_pekerjaan extends AppCompatActivity {
    ...
    public void addData(){
        ...
        listPekerjaans.add(new ListPekerjaan(R.drawable.gambar_depan_peneliti_kimia,
                ...
                "D3 Sederajat",
                "",
                "Peneliti dan teknisi kimia biasanya bekerja di perusahaan swasta seperti pabrik kimia. Tugas dari pekerjaan ini adalah mengembangkan produk kimia baru sesuai dengan core business perusahaan. Misalnya produk plastik, serat kimia, karet sintetis, atau lainnya.\n" +
                        "Selain di perusahaan-perusahaan yang ada di industri kimia dasar, peneliti dan teknisi kimia juga bisa bergabung di perusahaan farmasi, pertambangan dan perminyakan, juga lainnya. Seorang peneliti kimia juga bisa bekerja di lembaga penelitian negara atau institusi pendidikan.\n" +
                        "Biasanya peneliti yang bekerja di instansi tersebut sering berhadapan dengan penelitian-penelitian dasar seperti penemuan reagen pada produk kimia atau penelitian bahan kimia lainnya untuk memecahkan suatu permasalahan. Seorang peneliti dan teknisi kimia harus harus punya keterampilan teknis serta menguasai kaidah dan metode ilmiah.\n",
        ...
        listPekerjaans.add(new ListPekerjaan(R.drawable.gambar_depan_pengacara,
                ...
                "Pengacara biasa disebut Advokat, merupakan profesi yang menawarkan jasa hukum di dalam maupun di luar pengadilan. Jasa hukum yang diberikan bisa berupa konsultasi hukum, bantuan hukum, menjalankan kuasa, mewakili, mendampingi, membela, maupun tindak hukum lainnya untuk kepentingan klien. Yang menjadi klien bisa orang, badan hukum, atau lembaga lainnya. Nah, setelah pengacara menerima kuasa dari klien maka timbullah kewenangan pada dirinya untuk menjalankan profesinya sebagai penegak hukum. Dalam sistem penegakan hukum, pengacara yang punya kedudukan setara dengan hakim, jaksa, dan polisi. Meski begitu, peran dan fungsinya berbeda ya.\n" +
                        ...
                        "Nah, dalam praktiknya, pengacara harus mengkhususkan diri pada bidang tertentu. Tak heran ada firma hukum/kantor advokat yang fokus ke pekerjaan litigasi (jasa hukum di dalam pengadilan), tapi ada juga yang mengerjakan pekerjaan korporasi atau non-litigasi (jasa hukum di luar pengadilan).\n",
        ...
        listPekerjaans.add(new ListPekerjaan(R.drawable.gambar_depan_teknisi_mesin,
                ...
                "D3 Sederajat",
                "",
                "Perancang dan teknisi mesin bertugas merancang desain dan mengembangkan peralatan elektronik, peralatan komunikasi, otomotif, atau lainnya sesuai dengan bidang keahliannya. Selain pada bagian desain, profesi ini juga punya andil dalam pemeliharaan suatu sistem mekanik. Pekerjaan ini membutuhkan pengetahuan dan keterampilan yang berkaitan dengan teknik menggambar desain dan proses produksi secara keseluruhan seperti struktur suku cadang dan material yang digunakan. Bahkan setelah proses produksi selesai, pekerjaan ini membutuhkan simulasi untuk dilakukan pengembangan, seperti perbaikan sesuai kebutuhan dan pengenalan teknologi baru. Nah, yang lagi tren belakangan ini, para perancang dan teknisi mesin berlomba-lomba menciptakan alat dari sumber energi terbarukan. Jadi nilai plus deh untuk masuk ke bursa kerja perancang dan teknisi mesin kalau menguasai soal konversi energi mesin!",
        ...
        listPekerjaans.add(new ListPekerjaan(R.drawable.gambar_depan_perawat,
                ...
                "Perawat adalah seseorang yang bertugas memberikan asuhan pada individu, keluarga, juga kelompok dalam keadaan sakit maupun sehat. Secara umum, ada 2 jenis perawat, yaitu Perawat vokasi, minimal lulusan D3 Keperawatan, dan Perawat Profesi, minimal lulusan S1KeperawatanProfesi ini terdiri dari Ners dan Ners Spesialis. Seorang perawat setidaknya berperan sebagai care provider, manager and community leader, educator, advocate, juga researcher.. \n" +
                        "Dalam menjalankan profesinya, perawat akan bekerja sama dengan dokter umum, dokter spesialis, bidan, juga tenaga kesehatan lainnya. Di rumah sakit dan klinik, perawat mengikuti petunjuk dokter untuk mengurus dan membantu pasien dalam pemeriksaan kesehatan dan perawatan medis. Perawat memahami gejala pasien dengan tepat dan berupaya untuk mengatasinya. \n",
        ...
        listPekerjaans.add(new ListPekerjaan(R.drawable.gambar_depan_pilot,
                ...
                "Pilot bertugas mengoperasikan pesawat dengan aman. Seorang pilot bisa bekerja untuk pesawat komersial, helikopter untuk penyaluran barang dan informasi, maupun pesawat mesin kecil. Tapi, tahukah kalau ternyata, seorang pilot punya tanggung jawab yang besar sebagai kru pesawat. Dalam hal keamanan dan keselamatan penerbangan, pilot adalah sosok yang paling penting dan bertanggung jawab penuh.\n" +
                        ...
                        "Syarat menjadi seorang pilot adalah kesehatan tubuh, tentunya juga didukung dengan kemampuan spesialis dan kemampuan berbahasa asing. Pemeriksaan fisik bahkan dilakukan secara rutin setelah mulai pekerjaan sebagai pilot. Jika tidak memenuhi kriteria dalam fisik maka seseorang tidak dapat melanjutkan pekerjaan sebagai pilot.\n",
        ...
        listPekerjaans.add(new ListPekerjaan(R.drawable.gambar_depan_polisi,
                ...
                "SMA/K Sederajat",
                "",
                "Seperti anggota Avengers, seorang polisi mengemban tugas utama yaitu bertindak tegas dalam menghadapi kejahatan dan pelanggaran demi menjaga keamanan dan ketertiban masyarakat di muka bumi. Sebagai aparat penegak hukum, polisi memiliki peranan penting di setiap negara berdaulat. Di Indonesia, profesi ini berada dalam sebuah lembaga keren bernama Kepolisian Negara Republik Indonesia (POLRI). Tugas lainnya yang pasti bikin kamu makin bangga adalah melakukan tindakan pencegahan kriminal, melakukan penyelidikan terhadap pelanggaran hukum, memberikan perlindungan, mengawal orang-orang penting, dan sebagainya. Nggak cuma itu,, terdapat pula beberapa jenis tugas polisi yang lebih khusus seperti menjadi penyidik, mengidentifikasi sidik jari, mengatur lalu lintas, mengemudikan kapal laut, hingga bertanggung jawab mengatur anjing pelacak.",
        ...
        listPekerjaans.add(new ListPekerjaan(R.drawable.gambar_depan_pramugari,
                ...
                "Banyak orang yang menganggap profesi pramugari atau pramugara erat kaitannya dengan orang yang bekerja di dalam pesawat, padahal profesi ini sebenarnya ditujukan untuk semua moda transportasi. Selain pesawat, kamu juga akan bertemu dengan profesi ini di layanan Kereta Api dan Bus. Saat ini mulai banyak maskapai yang mengganti sebutan pramugari dan pramugara dengan awak kabin (cabin crew) atau flight attendant.\n" +
        ...
        listPekerjaans.add(new ListPekerjaan(R.drawable.gambar_depan_sutradara,
                ...
                "S1 Sederajat",
                "",
                "Sutradara menjadi penanggung jawab pada aspek artistik maupun teknis dalam pembuatan film. Selain bergerak dalam set produksi film, sama halnya dalam produksi pementasan drama. Sutradara harus kreatif dan punya pemahaman yang komprehensif di bidang sinematografi supaya bisa menghasilkan visualisasi film yang sesuai dengan naskah skenario. Pada saat proses produksi, sutradara akan mengarahkan akting para aktor dan aktris, juga kru film mulai dari posisi pengambilan gambar, pencahayaan, suara, dan sebagainya. Dalam hal ini sutradara harus memastikan jika timnya benar-benar bekerja secara profesional. Ketika produksi telah selesai, sutradara bersama editor akan melakukan proses editing gambar maupun suara. Nah, kalau kamu ingin jadi sutradara, bisa memulai karier lewat proyek independen, misalnya sebagai sutradara film indie atau film sekolah.",
        ...
        listPekerjaans.add(new ListPekerjaan(R.drawable.gambar_depan_teknisi_alatmedis,
                ...
                "D3 Sederajat",
                "",
                "Teknisi peralatan medik merupakan suatu profesi tenaga kesehatan yg bertanggung jawab penuh terhadap alat kesehatan yg berada di seluruh fasilitas layanan kesehatan. Seorang teknisi peralatan medis juga bertanggung jawab dalam mengoperasikan beberapa peralatan media dibawah kontrol dokter.\n" +
                        ...
                        "Teknisi alat kesehatan biasanya bekerja di tempat pelayanan kesehatan seperti puskesmas, rumah sakit dan sebagainya. Dalam melaksanakan tugasnya, teknisi alat kesehatan harus memiliki surat izin praktek dan Surat Tanda Registrasi (STR) yang harus diperpanjang setiap 5 tahun. Seorang teknisi alat kesehatan juga dibagi menjadi beberapa kategori tanggung jawab. Yaitu teknisi aplikasi, teknisi pemeliharaan, teknisi perbaikan, teknisi kalibrasi layak pakai serta teknisi instalasi dan perancangan.\n",
